...
def openssl():
    ...
    native.cc_library(
        ...
        copts = ['-DAES_ASM', '-DBSAES_ASM', '-DECP_NISTZ256_ASM', '-DENGINESDIR="\\"/usr/local/lib/engines-1.1\\""', '-DGHASH_ASM', '-DL_ENDIAN', '-DMD5_ASM', '-DNDEBUG', '-DOPENSSLDIR="\\"/usr/local/ssl\\""', '-DOPENSSL_BN_ASM_GF2m', '-DOPENSSL_BN_ASM_MONT', '-DOPENSSL_BN_ASM_MONT5', '-DOPENSSL_IA32_SSE2', '-DOPENSSL_NO_DYNAMIC_ENGINE', '-DOPENSSL_PIC', '-DOPENSSL_THREADS', '-DPADLOCK_ASM', '-DPOLY1305_ASM', '-DRC4_ASM', '-DSHA1_ASM', '-DSHA256_ASM', '-DSHA512_ASM', '-DVPAES_ASM', '-D_REENTRANT', '-I.', '-Icrypto/include', '-Iinclude'],
    ...
    native.cc_library(
        ...
        includes = openssl_includes,
        copts = ['-DAES_ASM', '-DBSAES_ASM', '-DECP_NISTZ256_ASM', '-DENGINESDIR="\\"/usr/local/lib/engines-1.1\\""', '-DGHASH_ASM', '-DL_ENDIAN', '-DMD5_ASM', '-DNDEBUG', '-DOPENSSLDIR="\\"/usr/local/ssl\\""', '-DOPENSSL_BN_ASM_GF2m', '-DOPENSSL_BN_ASM_MONT', '-DOPENSSL_BN_ASM_MONT5', '-DOPENSSL_IA32_SSE2', '-DOPENSSL_NO_DYNAMIC_ENGINE', '-DOPENSSL_PIC', '-DOPENSSL_THREADS', '-DPADLOCK_ASM', '-DPOLY1305_ASM', '-DRC4_ASM', '-DSHA1_ASM', '-DSHA256_ASM', '-DSHA512_ASM', '-DVPAES_ASM', '-D_REENTRANT', '-I.', '-Iinclude'],
        linkopts = openssl_linkopts,
        deps = [
          ':crypto',
        ]
    ...
    native.genrule(
        ...
        ] + ['/usr/bin/perl "$(location util/mkbuildinf.pl)" "cc -DNDEBUG -DOPENSSL_THREADS -DOPENSSL_NO_DYNAMIC_ENGINE -DOPENSSL_PIC -DOPENSSL_IA32_SSE2 -DOPENSSL_BN_ASM_MONT -DOPENSSL_BN_ASM_MONT5 -DOPENSSL_BN_ASM_GF2m -DSHA1_ASM -DSHA256_ASM -DSHA512_ASM -DRC4_ASM -DMD5_ASM -DAES_ASM -DVPAES_ASM -DBSAES_ASM -DGHASH_ASM -DECP_NISTZ256_ASM -DPADLOCK_ASM -DPOLY1305_ASM -DOPENSSLDIR=\\"\\\\\\"/usr/local/ssl\\\\\\"\\" -DENGINESDIR=\\"\\\\\\"/usr/local/lib/engines-1.1\\\\\\"\\" " darwin64-x86_64-cc > "$(location crypto/buildinf.h)"', '/usr/bin/perl -I. -Mconfigdata "$(location util/dofile.pl)" -oMakefile "$(location crypto/include/internal/bn_conf.h.in)" > "$(location crypto/include/internal/bn_conf.h)"', '/usr/bin/perl -I. -Mconfigdata "$(location util/dofile.pl)" -oMakefile "$(location crypto/include/internal/dso_conf.h.in)" > "$(location crypto/include/internal/dso_conf.h)"', '/usr/bin/perl -I. -Mconfigdata "$(location util/dofile.pl)" -oMakefile "$(location include/openssl/opensslconf.h.in)" > "$(location include/openssl/opensslconf.h)"', 'CC=cc /usr/bin/perl "$(location crypto/aes/asm/aes-x86_64.pl)" macosx "$(location crypto/aes/aes-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/aes/asm/aesni-mb-x86_64.pl)" macosx "$(location crypto/aes/aesni-mb-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/aes/asm/aesni-sha1-x86_64.pl)" macosx "$(location crypto/aes/aesni-sha1-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/aes/asm/aesni-sha256-x86_64.pl)" macosx "$(location crypto/aes/aesni-sha256-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/aes/asm/aesni-x86_64.pl)" macosx "$(location crypto/aes/aesni-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/aes/asm/bsaes-x86_64.pl)" macosx "$(location crypto/aes/bsaes-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/aes/asm/vpaes-x86_64.pl)" macosx "$(location crypto/aes/vpaes-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/bn/asm/rsaz-avx2.pl)" macosx "$(location crypto/bn/rsaz-avx2.s)"', 'CC=cc /usr/bin/perl "$(location crypto/bn/asm/rsaz-x86_64.pl)" macosx "$(location crypto/bn/rsaz-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/bn/asm/x86_64-gf2m.pl)" macosx "$(location crypto/bn/x86_64-gf2m.s)"', 'CC=cc /usr/bin/perl "$(location crypto/bn/asm/x86_64-mont.pl)" macosx "$(location crypto/bn/x86_64-mont.s)"', 'CC=cc /usr/bin/perl "$(location crypto/bn/asm/x86_64-mont5.pl)" macosx "$(location crypto/bn/x86_64-mont5.s)"', 'CC=cc /usr/bin/perl "$(location crypto/camellia/asm/cmll-x86_64.pl)" macosx "$(location crypto/camellia/cmll-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/chacha/asm/chacha-x86_64.pl)" macosx "$(location crypto/chacha/chacha-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/ec/asm/ecp_nistz256-x86_64.pl)" macosx "$(location crypto/ec/ecp_nistz256-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/md5/asm/md5-x86_64.pl)" macosx "$(location crypto/md5/md5-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/modes/asm/aesni-gcm-x86_64.pl)" macosx "$(location crypto/modes/aesni-gcm-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/modes/asm/ghash-x86_64.pl)" macosx "$(location crypto/modes/ghash-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/poly1305/asm/poly1305-x86_64.pl)" macosx "$(location crypto/poly1305/poly1305-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/rc4/asm/rc4-md5-x86_64.pl)" macosx "$(location crypto/rc4/rc4-md5-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/rc4/asm/rc4-x86_64.pl)" macosx "$(location crypto/rc4/rc4-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/sha/asm/sha1-mb-x86_64.pl)" macosx "$(location crypto/sha/sha1-mb-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/sha/asm/sha1-x86_64.pl)" macosx "$(location crypto/sha/sha1-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/sha/asm/sha256-mb-x86_64.pl)" macosx "$(location crypto/sha/sha256-mb-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/sha/asm/sha512-x86_64.pl)" macosx "$(location crypto/sha/sha256-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/sha/asm/sha512-x86_64.pl)" macosx "$(location crypto/sha/sha512-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/whrlpool/asm/wp-x86_64.pl)" macosx "$(location crypto/whrlpool/wp-x86_64.s)"', 'CC=cc /usr/bin/perl "$(location crypto/x86_64cpuid.pl)" macosx "$(location crypto/x86_64cpuid.s)"', 'CC=cc /usr/bin/perl "$(location engines/asm/e_padlock-x86_64.pl)" macosx "$(location engines/e_padlock-x86_64.s)"']),
    )
