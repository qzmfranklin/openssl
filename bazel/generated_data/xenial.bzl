...
crypto_asm_srcs = ['crypto/aes/aes-x86_64.s',
...
crypto_srcs = ['crypto/aes/aes_cfb.c',
...
crypto_generated_hdrs = ['crypto/include/internal/bn_conf.h',
 'crypto/include/internal/dso_conf.h',
 'include/openssl/opensslconf.h',
 'crypto/buildinf.h']

crypto_copts = ['-DAES_ASM',
 '-DBSAES_ASM',
 '-DDSO_DLFCN',
 '-DECP_NISTZ256_ASM',
...
genrule_outs = ['crypto/aes/aes-x86_64.s',
 'crypto/aes/aesni-mb-x86_64.s',
 'crypto/aes/aesni-sha1-x86_64.s',
 'crypto/aes/aesni-sha256-x86_64.s',
 'crypto/aes/aesni-x86_64.s',
